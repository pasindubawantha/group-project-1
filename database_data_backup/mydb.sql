...
(2001, 1001, 'Admin', 'admins address', 0, 'none', 1),
(2002, 1005, 'ceo1s name', 'ceo1s address', 3000000, 'chief executive officer', 1),
(2003, 1002, 'Technical Officer1 name', 'technical officer1 address', 3500, 'Technical Officer', 1),
(2004, 1002, 'Technical Officer2 name', 'technical officer2 address', 48970, 'Technical Officer', 1),
(2005, 1002, 'Technical Officer3 name', 'technical officer3 address', 45000, 'Technical Officer', 1),
(2006, 1003, 'Project Manger1 name', 'project manager1 address', 67000, 'Project Manager', 1),
(2007, 1003, 'Project Manger2 name', 'project manager2 address', 76000, 'Project Manager', 1),
(2008, 1003, 'Project Manger3 name', 'project manager3 address', 65000, 'Assistant Project Manager', 1),
(2009, 1006, 'Quantity servayor1 name', 'Quantity servayor1 address', 16000, 'Assistant Qunatity Survayor', 1),
(2010, 1006, 'Quantity servayor2 name', 'Quantity servayor2 address', 90000, 'Qunatity Survayor', 1),
(2011, 1004, 'Accountant 1 name', 'accountant1 address', 56000, 'Accountant', 1),
(2012, 1004, 'Accountant 2 name', 'accountant2 address', 27000, 'Assistant Accountant', 1);
