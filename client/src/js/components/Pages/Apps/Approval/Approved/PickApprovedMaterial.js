...
import PickInbox from "./Inbox/PickInbox.js"
import PickPending from "./Pending/PickPending.js"
import PickApproved from "./Approved/PickApproved.js"
...
export default class ApprovalApp extends React.Component {
	...
	//inbox to be approved requesrs all tab
			case "ApprovalsInboxAll":{
				return(<PickInbox />)
				break	
			}
	//Approved requests tab
			case "ApprovalsApprovedAll":{
				return(<PickApproved />)
				break
			}
	//Pending requests tab		
			case "ApprovalsPendingAll":{
				return(<PickPending />)
				break
			}
